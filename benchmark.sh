...
./benchsuite/benchsuite-size.sh report/baseline/$PREFIX-baseline.txt ./build/riscv64/baseline

# autovect
echo "> autovect"
mkdir report/autovect
./benchsuite/benchsuite-size.sh report/autovect/$PREFIX-autovect.txt ./build/riscv64/autovect
...
./benchsuite/benchsuite-params.sh \
    ...
    ./build/riscv64/reordered_tiling \
    SIZE="256,512,1024,2048,4096" \
    KERNEL="2,4,8,16" \
    LMUL="-2,1,2,4,8"
